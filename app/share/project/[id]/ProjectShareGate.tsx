...
export default function ProjectShareGate({ projectId, projectName }: { projectId: string; projectName: string }) {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="w-full max-w-sm text-center">
        ...
        <h1 className="text-xl tracking-widest uppercase font-light mb-1">{projectName}</h1>
        <p className="text-xs text-neutral-400 mb-10">Enter the password to view this project</p>
