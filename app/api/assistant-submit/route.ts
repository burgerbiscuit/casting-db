...
export async function POST(req: NextRequest) {
  ...
  const { error } = await svc.from('assistant_submissions').insert({
    ...
    languages: Array.isArray(fields.languages) ? fields.languages : null,
    skills: Array.isArray(fields.skills) ? fields.skills : null,
    software: Array.isArray(fields.software) ? fields.software : null,
